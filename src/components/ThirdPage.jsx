...
const ThirdPage = () => {
    ...
    return (
        <div className='ThirdPage  md:p-3 xl:p-5 2xl:p-10 relative'>
            <div className="leftside flex flex-col h-[500px] gap-10 sticky top-5 items-center justify-center p-5 ">
            ...
            <div className="rightside h-[500px] overflow-y-auto flex flex-col gap-2 p-2">
                <div className="flex items-center justify-between gap-5">
                    <img className='w-[30%] rounded-md' src={LaptopImg} alt="" />
                    <div className="flex flex-col content gap-2 justify-between h-[70%]">
                ...
                <div className="flex items-center justify-between gap-5">
                    ...
                    <img className='w-[30%] rounded-md' src={TableImg} alt="" />
                </div>
                <div className="flex items-center justify-between gap-5">
                    <img className='w-[30%] rounded-md' src={EventImg} alt="" />
                    <div className="flex flex-col content gap-2 justify-between h-[70%]">
